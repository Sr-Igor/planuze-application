...
function TablePaginationComponent({ pagination, loading, onPageChange, onLimitChange }: TablePaginationProps) {
    const t = useLang();
        ...
        <div className='bg-background flex items-center justify-between gap-4 border-t px-4 py-3'>
            ...
            <div className='text-muted-foreground flex items-center gap-4 text-sm'>
                ...
                <div className='hidden items-center gap-1 md:flex'>
                    ...
                    {loading ? <Skeleton className='h-4 w-8' /> : <span className='font-medium'>{count}</span>}
                </div>
            </div>
