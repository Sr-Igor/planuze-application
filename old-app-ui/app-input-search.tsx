...
export const AppInputSearch = <T extends { id: string }>({
    ...
    return (
        <div className={cn('transition-all duration-300 ease-in-out', className)} style={{ width: currentWidth }}>
            <DropdownMenu open={true} modal={false}>
                <DropdownMenuTrigger disabled={true} className='w-full transition-all duration-300 ease-in-out'>
