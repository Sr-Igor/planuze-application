import * as api from "#/web/req/project_kanban_cycle_card_comment";
        ...
        cache.setQueryData(showKey, (old: project_kanban_cycle_card) => {
          ...
          return {
            ...
            project_kanban_cycle_card_comments: [
              e,
              ...(old.project_kanban_cycle_card_comments || []),
            ],
          };
        });
      } finally {
    ...
    onSuccess: (e) => {
      try {
        cache.setQueryData(showKey, (old: project_kanban_cycle_card) => {
          ...
          return {
            ...old,
            project_kanban_cycle_card_comments: old.project_kanban_cycle_card_comments?.map(
              (comment) => (comment.id === e.id ? e : comment)
            ),
          };
        });
      } finally {
