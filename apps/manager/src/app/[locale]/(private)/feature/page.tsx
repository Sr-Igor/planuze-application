...
import { Atom, Eraser, Plus } from "lucide-react";
...
export default function Page() {
  ...
  return (
    <>
        ...
        headerRight={
          <div className="flex items-center gap-2">
            <Button onClick={() => handleState({ open: true, mode: "new", item: undefined })}>
              <Plus />
              <span className="ml-2 hidden lg:inline-block">{t.page.features("new")}</span>
            </Button>
          </div>
        }
        headerLeft={
      ...
      <FormDialog
        modalTitle={t.page.features(`modal.${state.mode!}.title`)}
        modalDescription={t.page.features(`modal.${state.mode!}.description`)}
