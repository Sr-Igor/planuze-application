...
export class SearchParamsUtils {
    ...
    static deserialize(searchParams: ReadonlyURLSearchParams | URLSearchParams): Record<string, string> {
    ...
    static parseWithSchema<T>(searchParams: ReadonlyURLSearchParams | URLSearchParams, schema: z.ZodSchema<T>): T {
    ...
    static merge(
        ...
        const searchParams = replaceAll ? new URLSearchParams() : new URLSearchParams(current.toString());
    ...
    static remove(current: ReadonlyURLSearchParams | URLSearchParams, keys: string[]): URLSearchParams {
