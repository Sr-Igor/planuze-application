...
export interface log__profile_role {
  id: string;
  ref_id: string | null;
...
export interface log__profile_roleCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: profile_roleCreateInput;
}

export type log__profile_roleUpdateInput = Partial<log__profile_roleCreateInput>;
