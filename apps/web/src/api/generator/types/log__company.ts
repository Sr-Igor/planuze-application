...
export interface log__companyCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: companyCreateInput;
}

export type log__companyUpdateInput = Partial<log__companyCreateInput>;
