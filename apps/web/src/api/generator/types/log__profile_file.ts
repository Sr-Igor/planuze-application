...
export interface log__profile_file {
  id: string;
  ref_id: string | null;
...
export interface log__profile_fileCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: profile_fileCreateInput;
}

export type log__profile_fileUpdateInput = Partial<log__profile_fileCreateInput>;
