...
export interface log__project_member {
  id: string;
  ref_id: string | null;
...
export interface log__project_memberCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: project_memberCreateInput;
}

export type log__project_memberUpdateInput = Partial<log__project_memberCreateInput>;
