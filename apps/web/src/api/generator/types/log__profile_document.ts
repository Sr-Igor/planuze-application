...
export interface log__profile_document {
  id: string;
  ref_id: string | null;
  ...
  createdAt: string;
  updatedAt: string;
  ref?: profile_document;
}

export interface log__profile_documentCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: profile_documentCreateInput;
}

export type log__profile_documentUpdateInput = Partial<log__profile_documentCreateInput>;
