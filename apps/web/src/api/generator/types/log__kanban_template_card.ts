...
export interface log__kanban_template_card {
  id: string;
  ref_id: string | null;
  ...
  createdAt: string;
  updatedAt: string;
  ref?: kanban_template_card;
}

export interface log__kanban_template_cardCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: kanban_template_cardCreateInput;
}

export type log__kanban_template_cardUpdateInput = Partial<log__kanban_template_cardCreateInput>;
