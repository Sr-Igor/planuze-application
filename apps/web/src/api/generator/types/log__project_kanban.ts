...
export interface log__project_kanban {
  id: string;
  ref_id: string | null;
...
export interface log__project_kanbanCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: project_kanbanCreateInput;
}

export type log__project_kanbanUpdateInput = Partial<log__project_kanbanCreateInput>;
