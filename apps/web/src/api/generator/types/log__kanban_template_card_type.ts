...
export interface log__kanban_template_card_type {
  id: string;
  ref_id: string | null;
  ...
  createdAt: string;
  updatedAt: string;
  ref?: kanban_template_card_type;
}

export interface log__kanban_template_card_typeCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: kanban_template_card_typeCreateInput;
}

export type log__kanban_template_card_typeUpdateInput = Partial<log__kanban_template_card_typeCreateInput>;
