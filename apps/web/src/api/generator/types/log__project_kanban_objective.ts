...
export interface log__project_kanban_objective {
  id: string;
  ref_id: string | null;
  ...
  createdAt: string;
  updatedAt: string;
  ref?: project_kanban_objective;
}

export interface log__project_kanban_objectiveCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: project_kanban_objectiveCreateInput;
}

export type log__project_kanban_objectiveUpdateInput = Partial<log__project_kanban_objectiveCreateInput>;
