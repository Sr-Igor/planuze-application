...
const query: Record<"include", Prisma.client_bank_accountInclude> = {
  include: {
    logs,
  },
};
...
export const index = async (filters?: any) => {
  const handle = callEndpoint({
    route: "/api/private/client_bank_account/index",
...
export const store = async (body: any, filters?: any) => {
  const handle = callEndpoint({
    route: "/api/private/client_bank_account/store",
    body,
    query: {
      ...filters,
      ...query,
...
export const update = async (id: string, body: any, filters?: any) => {
  const handle = callEndpoint({
    route: "/api/private/client_bank_account/update",
    body,
    params: { id },
    query: {
      ...filters,
...
export const destroy = async (id: string, filters?: any) => {
  const handle = callEndpoint({
    route: "/api/private/client_bank_account/destroy",
    params: { id },
    query: {
      ...filters,
      ...query,
...
export const trash = async (filters?: any) => {
  const handle = callEndpoint({
    route: "/api/private/client_bank_account/trash",
    query: {
      ...filters,
      ...query,
    },
...
export const restore = async (id: string, filters?: any) => {
  const handle = callEndpoint({
    route: "/api/private/client_bank_account/restore",
    params: { id },
    query: {
      ...filters,
      ...query,
