import { project_kanban_objective_target } from '@/api/generator/types';
import { useNestedArray } from '@/api/hooks/use-nested-array';
import * as api from '@/api/req/project_kanban_objective_target';
import { IUseCallerProps } from '@/api/types';

export const useProjectKanbanObjectiveTarget = (props: IUseCallerProps<project_kanban_objective_target>) => {
