...
import { project_kanban, project_kanban_cycle, project_kanban_cycle_column } from '@/api/generator/types';
import * as api from '@/api/req/project_kanban_cycle_column';
            ...
            try {
                ...
                cache.setQueryData(projectCycleKey, (old: project_kanban_cycle) => {
                    ...
                    if (moveCardsToColumn) {
                        ...
                        const deletedColumn = old.project_kanban_cycle_columns?.find((column) => column.id === e.id);
                        ...
                        if (deletedColumn && targetColumn) {
                            ...
                            return {
                                ...old,
                                project_kanban_cycle_columns: updatedColumns?.filter((column) => column.id !== e.id)
                            };
                        }
                    }
