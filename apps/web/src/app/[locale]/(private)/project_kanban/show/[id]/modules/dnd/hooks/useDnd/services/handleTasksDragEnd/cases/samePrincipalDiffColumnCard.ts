...
type SamePrincipalDiffColumnCardProps = {
...
export const samePrincipalDiffColumnCard = ({
    card,
    overCard,
    cycle,
    onBoardUpdate
}: SamePrincipalDiffColumnCardProps): boolean => {
    ...
    if (targetColumn) {
        // Obter cards da mesma task principal na coluna de destino (excluindo o card que está sendo movido)
