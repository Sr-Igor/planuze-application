...
import { IUsePageReturnProps, IUseReqReturnProps, IUseSelectReturnProps } from '../hooks/use-req/types';
...
export interface IUseCallersReturnProps {
    ...
    card: {
        ...
        onTrash: () => UseInfiniteQueryResult<InfiniteData<Pagination<project_kanban_cycle_card>, unknown>, Error>;
