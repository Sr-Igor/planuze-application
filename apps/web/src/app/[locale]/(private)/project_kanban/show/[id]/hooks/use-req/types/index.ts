...
import { BoardUpdateProps, IProfile } from '@/app/[locale]/(private)/project_kanban/show/[id]/types';
...
export interface Services {
    cycle: {
        ...
        restore: UseMutationResult<project_kanban_cycle | Pagination<project_kanban_cycle>, Error, { id: string }>;
    };
    column: {
        update: UseMutationResult<
        ...
        >;
        many: UseMutationResult<project_kanban_cycle_column[] | Pagination<project_kanban_cycle_column>, Error, any>;
    ...
    card: {
        ...
        >;
        many: UseMutationResult<project_kanban_cycle_card | Pagination<project_kanban_cycle_card>, Error, any>;
        trash: UseInfiniteQueryResult<InfiniteData<Pagination<project_kanban_cycle_card>, unknown>, Error>;
        restore: UseMutationResult<
            project_kanban_cycle_card | Pagination<project_kanban_cycle_card>,
            Error,
            Partial<project_kanban_cycle_card>
    ...
    member: {
        ...
        store: UseMutationResult<project_member | Pagination<project_member>, Error, Partial<project_member>>;
        ...
        restore: UseMutationResult<project_member | Pagination<project_member>, Error, string | undefined>;
    };
    report: {
    ...
    config: {
        ...
        store: UseMutationResult<project_config | Pagination<project_config>, Error, Partial<project_config>>;
        update: UseMutationResult<project_config | Pagination<project_config>, Error, Partial<project_config>>;
        ...
        restore: UseMutationResult<project_config | Pagination<project_config>, Error, string | undefined>;
    };
    globalAllocation: {
        ...
        restore: UseMutationResult<project_allocation | Pagination<project_allocation>, Error, string | undefined>;
    };
    tool: {
        ...
        update: UseMutationResult<project_tool | Pagination<project_tool>, Error, Partial<project_tool>>;
