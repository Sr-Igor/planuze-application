    ...
    const fields: Field<Form>[] = [
        {
            ...
            fallbackValue: state?.item?.profile?.user?.name || state?.item?.profile?.anonymous_name || '-'
        },
        {
            field: 'infinity_select',
            ...
            fallbackValue: state?.item?.project_version ? `V${state?.item?.project_version?.version}` : undefined
        },
        {
            field: 'calendar',
            name: 'start_date',
