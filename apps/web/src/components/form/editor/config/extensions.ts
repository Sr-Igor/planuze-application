...
import { Hashtag } from '../modules/hashtag/hashtag-extension';
import { Mention } from '../modules/mention/mention-extension';
...
export const createEditorExtensions = (
    ...
    // Adiciona extensões condicionalmente baseado nas queries disponíveis
    if (mentionQuery) {
        extensions.push(
            Mention.configure({
                HTMLAttributes: {
