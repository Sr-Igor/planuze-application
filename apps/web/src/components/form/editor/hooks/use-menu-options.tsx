...
import type { MenuOption, ModalType } from "../types";
...
export const useMenuOptions = (editor: Editor, onOpenModal: (type: ModalType) => void) => {
  ...
  // Força re-render quando o editor muda
  useEffect(() => {
    if (!editor) return;
    ...
    const alignmentOptions: MenuOption[] = [
      {
        ...
        onClick: () => {
          if (editor.isActive("image")) {
            // Detectar alinhamento atual antes de aplicar
  ...
  }, [editor, onOpenModal, resolvedTheme, forceUpdate]);
