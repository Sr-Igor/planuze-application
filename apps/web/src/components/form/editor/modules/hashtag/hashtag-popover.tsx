...
export const HashtagPopover: React.FC<HashtagPopoverProps> = ({
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      switch (e.key) {
        case "ArrowDown":
          ...
          // Mantém o foco no editor de forma assíncrona
          if (editor) {
            setTimeout(() => {
  ...
  // Reset selectedIndex para 0 quando o popover abrir
  useEffect(() => {
    if (open) {
      setSelectedIndex(0);
    }
  ...
  // Garante que selectedIndex não exceda o número de itens
  useEffect(() => {
  ...
  // Renderizar usando Portal para escapar da hierarquia do Dialog
