...
import {
  IComponentRegistry,
  IFieldComponent,
  RegisterableFieldComponent,
} from "../../domain/interfaces/component.interface";
...
export class ComponentFactory {
   ...
   * Accepts components with additional props beyond IFieldComponentProps
   */
  static register(fieldType: string, component: RegisterableFieldComponent): void {
