...
export interface log__profileCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: profileCreateInput;
}

export type log__profileUpdateInput = Partial<log__profileCreateInput>;
