...
export interface log__project_kanban_cycle {
  id: string;
  ref_id: string | null;
  ...
  createdAt: string;
  updatedAt: string;
  ref?: project_kanban_cycle;
}

export interface log__project_kanban_cycleCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: project_kanban_cycleCreateInput;
}

export type log__project_kanban_cycleUpdateInput = Partial<log__project_kanban_cycleCreateInput>;
