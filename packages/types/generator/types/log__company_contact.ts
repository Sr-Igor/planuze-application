...
export interface log__company_contact {
  id: string;
  ref_id: string | null;
...
export interface log__company_contactCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: company_contactCreateInput;
}

export type log__company_contactUpdateInput = Partial<log__company_contactCreateInput>;
