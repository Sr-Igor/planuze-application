...
export interface log__company_config {
  id: string;
  ref_id: string | null;
...
export interface log__company_configCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: company_configCreateInput;
}

export type log__company_configUpdateInput = Partial<log__company_configCreateInput>;
