...
export interface log__company_address {
  id: string;
  ref_id: string | null;
...
export interface log__company_addressCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: company_addressCreateInput;
}

export type log__company_addressUpdateInput = Partial<log__company_addressCreateInput>;
