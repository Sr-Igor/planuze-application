...
export interface log__kanban_template_tag {
  id: string;
  ref_id: string | null;
  ...
  createdAt: string;
  updatedAt: string;
  ref?: kanban_template_tag;
}

export interface log__kanban_template_tagCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: kanban_template_tagCreateInput;
}

export type log__kanban_template_tagUpdateInput = Partial<log__kanban_template_tagCreateInput>;
