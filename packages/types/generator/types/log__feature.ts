...
export interface log__featureCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: featureCreateInput;
}

export type log__featureUpdateInput = Partial<log__featureCreateInput>;
