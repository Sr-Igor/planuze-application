...
export interface log__integration {
  id: string;
  ref_id: string | null;
...
export interface log__integrationCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: integrationCreateInput;
}

export type log__integrationUpdateInput = Partial<log__integrationCreateInput>;
