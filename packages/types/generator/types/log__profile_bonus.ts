...
export interface log__profile_bonus {
  id: string;
  ref_id: string | null;
...
export interface log__profile_bonusCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: profile_bonusCreateInput;
}

export type log__profile_bonusUpdateInput = Partial<log__profile_bonusCreateInput>;
