...
export interface log__client_file {
  id: string;
  ref_id: string | null;
...
export interface log__client_fileCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: client_fileCreateInput;
}

export type log__client_fileUpdateInput = Partial<log__client_fileCreateInput>;
