...
export interface log__project_allocation {
  id: string;
  ref_id: string | null;
  ...
  createdAt: string;
  updatedAt: string;
  ref?: project_allocation;
}

export interface log__project_allocationCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: project_allocationCreateInput;
}

export type log__project_allocationUpdateInput = Partial<log__project_allocationCreateInput>;
