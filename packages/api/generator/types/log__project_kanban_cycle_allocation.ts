...
export interface log__project_kanban_cycle_allocation {
  id: string;
  ref_id: string | null;
  ...
  createdAt: string;
  updatedAt: string;
  ref?: project_kanban_cycle_allocation;
}

export interface log__project_kanban_cycle_allocationCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: project_kanban_cycle_allocationCreateInput;
}

export type log__project_kanban_cycle_allocationUpdateInput = Partial<log__project_kanban_cycle_allocationCreateInput>;
