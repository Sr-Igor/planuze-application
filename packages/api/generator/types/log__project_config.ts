...
export interface log__project_config {
  id: string;
  ref_id: string | null;
...
export interface log__project_configCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: project_configCreateInput;
}

export type log__project_configUpdateInput = Partial<log__project_configCreateInput>;
