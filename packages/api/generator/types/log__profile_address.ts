...
export interface log__profile_address {
  id: string;
  ref_id: string | null;
...
export interface log__profile_addressCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: profile_addressCreateInput;
}

export type log__profile_addressUpdateInput = Partial<log__profile_addressCreateInput>;
