...
export interface log__inviteCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: inviteCreateInput;
}

export type log__inviteUpdateInput = Partial<log__inviteCreateInput>;
