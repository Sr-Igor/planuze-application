...
export interface log__company_document {
  id: string;
  ref_id: string | null;
  ...
  createdAt: string;
  updatedAt: string;
  ref?: company_document;
}

export interface log__company_documentCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: company_documentCreateInput;
}

export type log__company_documentUpdateInput = Partial<log__company_documentCreateInput>;
