...
export interface log__clientCreateInput {
  id?: string;
  ref_id?: string | null;
  auth_api?: string | null;
  ...
  createdAt?: string;
  updatedAt?: string;
  ref?: clientCreateInput;
}

export type log__clientUpdateInput = Partial<log__clientCreateInput>;
