...
export type SidebarGroupLabelProps = ComponentPropsWithoutRef<"div"> & { asChild?: boolean };
...
export type SidebarGroupActionProps = ComponentPropsWithoutRef<"button"> & { asChild?: boolean };
...
export type SidebarMenuActionProps = ComponentPropsWithoutRef<"button"> & {
  asChild?: boolean;
  showOnHover?: boolean;
};
...
export type SidebarMenuSkeletonProps = ComponentPropsWithoutRef<"div"> & { showIcon?: boolean };
...
export type SidebarMenuSubButtonProps = ComponentPropsWithoutRef<"a"> & {
  asChild?: boolean;
  size?: "sm" | "md";
  isActive?: boolean;
};
