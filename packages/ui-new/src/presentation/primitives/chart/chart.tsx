 ...
 *
 * Data visualization components built on top of Recharts.
 *
 * @module presentation/primitives/chart
 */
...
/**
 * Chart style component for injecting CSS variables.
 */
function ChartStyle({ id, config }: Readonly<ChartStyleProps>) {
