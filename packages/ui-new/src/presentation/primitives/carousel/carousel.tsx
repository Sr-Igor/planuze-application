 ...
 *
 * A carousel component for displaying a series of content.
 *
 * @module presentation/primitives/carousel
 */
...
export type CarouselRootProps = ComponentPropsWithoutRef<"div"> & CarouselProps;

const Carousel = forwardRef<HTMLDivElement, CarouselRootProps>(
  (
