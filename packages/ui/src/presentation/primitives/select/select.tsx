...
>(({ className, children, disabled, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    disabled={disabled}
    className={cn(
      "border-input bg-background flex h-9 w-full items-center justify-between rounded-md border px-3 py-2 text-sm shadow-sm",
      "transition-all duration-200 outline-none",
      "data-placeholder:text-muted-foreground/70",
      "[&_svg:not([class*='text-'])]:text-muted-foreground",
      "hover:border-primary/30",
      "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:shadow-md focus-visible:ring-[3px]",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        "bg-popover/95 text-popover-foreground relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border shadow-lg backdrop-blur-sm",
...
const SelectLabel = forwardRef<React.ElementRef<typeof SelectPrimitive.Label>, SelectLabelProps>(
  ({ className, ...props }, ref) => (
